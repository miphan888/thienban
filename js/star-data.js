...
Object.assign(window.STAR_INFO, {
  ...
  'Cô Thần': {
  hanh:'Hỏa', nhom:'Tạp Tinh', amduong:'Dương', icon:'🕯', color:'#A9B8CC',
  tomtat:'Cô độc tinh — chủ về cô đơn, lẻ loi, xa cách người thân.',
  cachdoan:[
    'Nam mệnh Cô Thần: xa cha mẹ hoặc khắc vợ',
    'Cô Quả cùng Mệnh: rất cô đơn',
  ...
  phu:'Cô Thần chủ về cô đơn, lẻ loi.'
},
'Quả Tú': {
  hanh:'Hỏa', nhom:'Tạp Tinh', amduong:'Âm', icon:'🕯', color:'#A9B8CC',
  tomtat:'Cô độc tinh — chủ về góa bụa, cô đơn. Tương tự Cô Thần nhưng dành cho nữ.',
  cachdoan:[
    'Nữ mệnh Quả Tú: dễ góa bụa hoặc không chồng',
    'Cô Quả cùng Mệnh: rất cô đơn'
  ],
  phu:'Quả Tú chủ về góa bụa, cô đơn.'
},
'Thiên Thương': {
  hanh:'Thủy', nhom:'Tạp Tinh', amduong:'Âm', icon:'💔', color:'#FF6B6B',
  tomtat:'Hung tinh — chủ về thương tổn, hư hao. Đóng cung Quan Lộc.',
  cachdoan:[
    'Thiên Thương tại Quan: sự nghiệp có lúc bị tổn thương',
    'Hội hung tinh: tai nạn nghề nghiệp'
  ],
  phu:'Thiên Thương chủ thương tổn, đóng cố định tại Quan Lộc.'
},
'Thiên Sứ': {
  hanh:'Thủy', nhom:'Tạp Tinh', amduong:'Âm', icon:'📩', color:'#A9B8CC',
  tomtat:'Hung tinh — chủ về bệnh tật, tai ương. Đóng cung Tật Ách.',
  cachdoan:[
    'Thiên Sứ tại Tật: dễ có bệnh nặng hoặc tai nạn',
    'Đại hạn gặp Thiên Sứ: cẩn thận sức khỏe'
  ],
  phu:'Thiên Sứ chủ bệnh tật, đóng cố định tại Tật Ách.'
},
'Phá Toái': {
  hanh:'Hỏa', nhom:'Tạp Tinh', amduong:'Dương', icon:'💥', color:'#FF9F43',
  tomtat:'Hung tinh nhỏ — chủ về phá vỡ, bất toàn, khuyết điểm.',
  cachdoan:[
    'Phá Toái tại Mệnh: có tật nhỏ hoặc khuyết điểm ngoại hình',
    'Hội sao tốt: tài hoa nhưng không toàn vẹn'
  ],
  phu:'Phá Toái chủ sự bất toàn, khuyết phá.'
},
'Đẩu Quân': {
  hanh:'Hỏa', nhom:'Tạp Tinh', amduong:'Dương', icon:'🎯', color:'#FFD97D',
  tomtat:'Nguyệt lệnh tinh — chủ về lưu niên vận khí, coi nguyệt hạn.',
  cachdoan:[
    'Đẩu Quân rất quan trọng cho tiểu hạn',
    'Dùng Đẩu Quân để tính nguyệt hạn (vận tháng)'
  ],
  phu:'Đẩu Quân chủ nguyệt lệnh, ảnh hưởng đến tiểu hạn.'
},
'Long Trì': {
  hanh:'Thủy', nhom:'Tạp Tinh', amduong:'Dương', icon:'🐉', color:'#4ECDB4',
  tomtat:'Cát tinh — chủ về tài hoa, văn chương, danh tiếng.',
  cachdoan:[
    'Long Trì Phượng Các hội Mệnh: văn tài xuất chúng',
    'Long Trì miếu Thìn (Long cư Long vị): đặc cách'
  ],
  phu:'Long Trì chủ văn tài, danh tiếng.'
},
'Phượng Các': {
  hanh:'Mộc', nhom:'Tạp Tinh', amduong:'Âm', icon:'🦅', color:'#4ECDB4',
  tomtat:'Cát tinh — chủ về tài hoa, văn nghệ, nhan sắc. Đi cặp Long Trì.',
  cachdoan:[
    'Long Trì Phượng Các cùng cung Mệnh: tài hoa, thanh lịch',
    'Hội Xương Khúc: tài văn nghệ xuất sắc'
  ],
  phu:'Phượng Các chủ văn nghệ, nhan sắc. Đi cặp Long Trì.'
},
'Kiếp Sát': {
  hanh:'Hỏa', nhom:'Hung Tinh', amduong:'Dương', icon:'⚡', color:'#FF6B6B',
  tomtat:'Hung tinh — chủ tai nạn bất ngờ, kiếp nạn.',
  cachdoan:['Kiếp Sát tại Mệnh: hay gặp tai nạn','Hội Kình Đà Hỏa Linh: nguy hiểm'],
  phu:'Kiếp Sát chủ tai nạn, kiếp nạn bất ngờ.'
},
'Hoa Cái': {
  hanh:'Kim', nhom:'Tạp Tinh', amduong:'Dương', icon:'👑', color:'#B78FFF',
  tomtat:'Cát tinh — chủ thanh cao, tôn quý, nghệ thuật.',
  cachdoan:['Hoa Cái tại Mệnh: thanh cao tựng chúng','Hội Không Kiếp: cô đơn thanh cao'],
  phu:'Hoa Cái chủ thanh cao, tôn quý.'
},
'Thiên Đức': {
  hanh:'Thổ', nhom:'Tạp Tinh', amduong:'Dương', icon:'✨', color:'#FFD97D',
  tomtat:'Đức tinh — chủ phúc đức, giải tai ách.',
  cachdoan:['Thiên Nguyệt Đức hội Mệnh: phúc đức dày','Gặp hung tinh: giảm bớt tác hại'],
  phu:'Thiên Đức chủ phúc đức, giải tai ách.'
},
'Nguyệt Đức': {
  hanh:'Thổ', nhom:'Tạp Tinh', amduong:'Âm', icon:'✨', color:'#FFD97D',
  tomtat:'Đức tinh — chủ phúc đức, đi cặp Thiên Đức.',
  cachdoan:['Song Đức hội Mệnh: được giải nạn nhiều lần','Cung Phúc Đức có Nguyệt Đức: âm đức nhiều'],
  phu:'Nguyệt Đức đi cặp Thiên Đức, giải họa.'
},
'Thiên Quan': {
  hanh:'Hỏa', nhom:'Tạp Tinh', amduong:'Dương', icon:'🏛', color:'#FFD97D',
  tomtat:'Quý nhân tinh — chủ được quý nhân phù trợ về quan lộc.',
  cachdoan:['Thiên Quan tại Quan Lộc: thăng tiến thuận lợi'],
  phu:'Thiên Quan Quý Nhân chủ được quý nhân giúp đỡ.'
},
'Thiên Phúc': {
  hanh:'Thổ', nhom:'Tạp Tinh', amduong:'Dương', icon:'🍀', color:'#4ECDB4',
  tomtat:'Quý nhân tinh — chủ được phúc lộc, hưởng phúc tự nhiên.',
  cachdoan:['Thiên Phúc tại Mệnh: bình sinh nhiều phúc'],
  phu:'Thiên Phúc Quý Nhân chủ phúc lộc tự nhiên.'
},
'Ân Quang': {
  hanh:'Hỏa', nhom:'Tạp Tinh', amduong:'Dương', icon:'🌟', color:'#FFD97D',
  tomtat:'Cát tinh — chủ ân phong, được ban thưởng, quý hiển.',
  cachdoan:['Ân Quang Thiên Quý hội Mệnh: được ân sủng từ trên'],
  phu:'Ân Quang chủ ân phong, quý hiển.'
},
'Thiên Quý': {
  hanh:'Thổ', nhom:'Tạp Tinh', amduong:'Dương', icon:'🌟', color:'#FFD97D',
  tomtat:'Cát tinh — chủ quý hiển, đi cặp Ân Quang.',
  cachdoan:['Thiên Quý tại Mệnh: thêm sang trọng hơn người'],
  phu:'Thiên Quý chủ quý hiển, đi cặp Ân Quang.'
},
});
